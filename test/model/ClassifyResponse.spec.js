...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PassioFoodCatalog.ClassifyResponse();
  });
  ...
  describe('ClassifyResponse', function() {
    it('should create an instance of ClassifyResponse', function() {
      // uncomment below and update the code to test ClassifyResponse
      //var instane = new PassioFoodCatalog.ClassifyResponse();
      //expect(instance).to.be.a(PassioFoodCatalog.ClassifyResponse);
    });
